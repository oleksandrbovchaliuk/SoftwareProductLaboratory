...
export class DraggingTool extends go.DraggingTool {
  ...
  public showHorizontalMatches(
    ...
    let bestObj: go.Part | null = null // TS 2.6 won't let this be go.Part | null
    ...
    if (bestObj !== null) {
      ...
      const bestBounds = (bestObj as go.Part).locationObject.getDocumentBounds()
  ...
  public showVerticalMatches(
    ...
    let bestDiff: number = marginOfError
    let bestObj: unknown = null // TS 2.6 won't let this be go.Part | null
    let bestSpot: go.Spot = go.Spot.Default
    let bestOtherSpot: go.Spot = go.Spot.Default
